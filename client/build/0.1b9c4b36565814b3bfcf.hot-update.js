...
var HomePage = function (_Component) {
    ...
    _createClass(HomePage, [{
        ...
        value: function handleAreas(areas) {
            ...
            areas = areas.filter(function (o) {
                for (var i = 0; i < _this2.props.areas.length; i++) {
                    if (_this2.props.areas[i].id == o.id) {
                        return false;
                    }
                }
                return true;
...
//# sourceMappingURL=0.1b9c4b36565814b3bfcf.hot-update.js.map